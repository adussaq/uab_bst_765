    ...
    a_createPage = function () {
        ...
        (function () {
            ...
            bootstrapRunner.all().then(function () {
                ...
                fig.google_options.title = "Comparison of Mean Pain Scores. Utilizes a 5000 repitition bootstrap to generate 80% and 95% confidence intervals.";
                ...
                fig.google_options.vAxis = {viewWindow: {min: 0, max:10}};
                fig.google_options.title = "Comparison of Median Pain Scores. Utilizes a 5000 repitition bootstrap to generate 80% and 95% confidence intervals.";
                chart.draw(fig.google_data, fig.google_options);
                ...
                fig.google_options.vAxis = {viewWindow: {min: 0, max:10}};
                fig.google_options.title = "Comparison of First and Third Quartile Pain Scores. Utilizes a 5000 repitition bootstrap to generate 80% and 95% confidence intervals.";
                chart.draw(fig.google_data, fig.google_options);
        ...
        (function () {
            ...
            bootstrapRunner.all().then(function () {
                ...
                fig.google_options.title = "Comparison of Mean Change in Pain Scores from Time 0. Utilizes a 5000 repitition bootstrap to generate 80% and 95% confidence intervals.";
                ...
                fig.google_options.vAxis = {viewWindow: {min: -10, max:1}};
                fig.google_options.title = "Comparison of Median Change in Pain Scores from Time 0. Utilizes a 5000 repitition bootstrap to generate 80% and 95% confidence intervals.";
                chart.draw(fig.google_data, fig.google_options);
                ...
                fig.google_options.vAxis = {viewWindow: {min: -10, max:1}};
                fig.google_options.title = "Comparison of First and Third Quartile Change in Pain Scores from Time 0. Utilizes a 5000 repitition bootstrap to generate 80% and 95% confidence intervals.";
                chart.draw(fig.google_data, fig.google_options);
